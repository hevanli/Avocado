		...
		public void DoFollow() {
			...
			if (followRotation) {
				if (smoothRotationFollow == 0) {
					...
					selfRot = self.rotation;
					whoToFollowRot = whoToFollow.rotation;
					self.rotation = Quaternion.RotateTowards(self.rotation, whoToFollow.rotation, smoothRotationFollow * Time.deltaTime);
				}
			}
		}
		public Quaternion whoToFollowRot, selfRot;
